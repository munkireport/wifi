                    ...
                    if(skipThese.indexOf(prop) == -1){
                        ...
                        // Do nothing for empty values to blank them
                           ...
                           // rows = rows + '<tr><th>'+i18n.t('wifi.'+prop)+'</th><td><span title="'+i18n.t('wifi.snr_detail')+'">'+d[prop]+' db</span></td></tr>';
                            ...
                            rows = rows + '<tr><th>'+i18n.t('wifi.'+prop)+'</th><td><span class="label label-'+labelClass+'" title="'+i18n.t('wifi.snr_detail')+'">'+d[prop]+' db</span></td></tr>';
                        }
                        else if(prop == 'snr'){
                            ...
                            rows = rows + '<tr><th>'+i18n.t('wifi.'+prop)+'</th><td><span class="label label-'+labelClass+'" title="'+i18n.t('wifi.snr_detail')+'">'+snr_value+' db</span></td></tr>';
                        }
                           ...
                           rows = rows + '<tr><th>'+i18n.t('wifi.'+prop)+'</th><td><span title="'+i18n.t('wifi.noise_detail')+'">'+d[prop]+' db</span></td></tr>';
                            ...
                            if (d[prop] === 'running') {
                                ...
                                labelClass = 'warning';
                            } else if (d[prop] === 'no wifi') {
                                labelClass = 'info';
                            } else {
                                labelClass = 'warning';
                            }

                           rows = rows + '<tr><th>'+i18n.t('wifi.'+prop)+'</th><td><span class="label label-'+labelClass+'">'+i18n.t('wifi.'+d[prop])+'</span></td></tr>';
                        }

                        else if((prop == 'link_auth' && d[prop].includes("-"))){
